        ...
        <div className="col col-11 mx-auto">
            <div className="row bg-white rounded shadow-sm p-2 add-todo-wrapper align-items-center justify-content-center">
                ...
                <div className="col-auto px-0 mx-0 mr-2">
                    <button type="button" onClick={(e) => setToDos([...toDos,{text:toDo, status:false}])} className="btn btn-primary">Add</button>
                    {/* SpreadOperator */}
                </div>
            </div>
        </div>
    ...
    <div className="col mx-auto">
        <div className="row px-3 align-items-center todo-item rounded">
            <div className="col-auto m-1 p-0 d-flex align-items-center">
                <h2 className="m-0 p-0">
                   ...
                   {/* <i className="fa fa-square-o text-primary btn m-0 p-0" data-toggle="tooltip" data-placement="bottom" title="Mark as todo"></i>  */}
                    {/* <input className="fa fa-square-o text-primary btn m-0 p-0" type="checkbox"  name="" id=""/> */}
      ...
      <i className="fa fa-square-o text-primary btn m-0 p-0" ></i>
            ...
            <div className="col px-1 m-1 d-flex align-items-center">
                <input type="text" className="form-control form-control-lg border-0 edit-todo-input bg-transparent rounded px-3" readonly value={obj.text}/>
                {/* <input type="text" className="form-control form-control-lg border-0 edit-todo-input rounded px-3 d-none" value={value} /> */}
            </div>
